...
En los siguientes dos gráficos, se presenta la información previa visualmente: inicialmente se muestra el porcentaje de variabilidad que explica cada componente, ordenadas de mayor a menor. 
...
Gráficamente, una variable que esté más cerca al círculo unitario indica mayor contribución.Análogamente, una variable que forme un ángulo más pequeño con el eje respectivo de la componente principal indica mayor calidad, en otras palabras, mientras "más pegada" esté la variable a la CP, será de mayor calidad. Esto, se traduce en que una calidad se puede considerar alta cuando el $\cos^2(\theta) \geq 0.9$.
...
significativas entre la exactitud de estos.

Cabe aclarar que se emplearon métodos no paramétricos para contrastar las hipótesis plantedas, además, dado que se realización k-fold cross validation se
...
que la exactitud media de ambos modelos es la misma.
...
tan cercano a 1 evidencia una fuerte concordancia entre la igualdad de las medias
...
desemboca en un proceso más rápido yeficiente.
